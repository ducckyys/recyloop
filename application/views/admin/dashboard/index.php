             ...
             <div class="row">
                 <div class="col-lg-3">
                     <div class="card border border-dark"
                         style="height: 250px; margin-bottom: 20px; color: aquamarine;">
                 ...
                 <div class="col-lg-3">
                     <div class=" card border border-dark"
                         style=" height: 250px; margin-bottom: 20px; color: springgreen;">
                         <div class="card-header"
                             style="background-color: #fff; color: black; text-align: center; border-top-left-radius: 10px; border-top-right-radius: 10px;">
                             Jumlah Staff
                         </div>
                 ...
                 <div class="col-lg-6">
                     <table class="table table-bordered">
                         <thead class="thead-light">
                             <tr>
                                 <th style="border-top-left-radius: 10px;">Dana</th>
